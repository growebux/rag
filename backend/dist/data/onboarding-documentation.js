...
exports.onboardingDocuments = exports.onboardingSteps = exports.OnboardingStepStatus = void 0;
exports.getDocumentsBySection = getDocumentsBySection;
...
(function (OnboardingStepStatus) {
    ...
    OnboardingStepStatus["IN_REVIEW"] = "in_review";
    OnboardingStepStatus["REWORK_REQUIRED"] = "rework_required";
    OnboardingStepStatus["APPROVED"] = "approved";
...
exports.onboardingDocuments = exports.onboardingSteps.flatMap(step => step.documents.map(doc => ({
    id: doc.id,
    title: doc.title,
    content: doc.content,
    ...
    section: (() => {
        const sectionMap = {
            acquisition: rag_1.OnboardingSectionType.PROFILE, // Map acquisition to profile for now
            profile: rag_1.OnboardingSectionType.PROFILE,
            'personal-info': rag_1.OnboardingSectionType.PERSONAL_INFO,
            tours: rag_1.OnboardingSectionType.TOURS,
            calendar: rag_1.OnboardingSectionType.CALENDAR,
            quiz: rag_1.OnboardingSectionType.QUIZ,
        };
        return sectionMap[doc.section] || rag_1.OnboardingSectionType.PROFILE;
    })(),
})));
// Helper function to get documents by section
function getDocumentsBySection(section) {
    return exports.onboardingDocuments.filter(doc => doc.section === section);
}
// Helper function to get all section types
function getAllSections() {
    return Object.values(rag_1.OnboardingSectionType);
}
// Helper function to get document by ID
function getDocumentById(id) {
    return exports.onboardingDocuments.find(doc => doc.id === id);
}
//# sourceMappingURL=onboarding-documentation.js.map